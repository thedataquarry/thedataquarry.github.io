...
and can break in various ways. They are verbose and require some massaging to get the LLM to output you need. Importantly, the developers
building these systems need to _test_ their components.
...
{{ figure(src="baml-tier-functions.png") }}
...
{{ figure(src="baml-encapsulation.png") }}
...
{{ twitter(url="https://twitter.com/aaron__vi/status/1884137401834152375" class="twitter")}}
