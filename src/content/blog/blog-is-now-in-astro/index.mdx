...
I asked in Cursor chat to put Claude 3.7 Sonnet to work:

<Image src={Img1} alt="Explaining to Claude 3.7 Sonnet about the datetime issue in the Astro theme" />
...
<Image src={Img2} alt="Claude 3.7 Sonnet suggesting a solution in Cursor's chat interface" />
