...
As a result, it's crucial to have a "brainstorming" step *prior* to planning. Rather than go free form and prompt the model to brainstorm with me, I use this [brainstorming skill](https://github.com/prrao87/agent-skills/blob/main/skills/brainstorming/SKILL.md) adapted from the one written by my good friend [Noorain Panjwani](https://github.com/YourTechBud) — feel free to copy and adapt it for your own needs!
...
The purpose of the brainstorming skill isn't to generate writing ideas for you — it's to help you clarify your own thinking. When prompted to use the skill, the agent takes the seed prompt, reasons over it, ideates with you, asking questions where necessary, and finally outputs a new local artifact file (the skill specifically asks for an HTML artifact). AI is your *partner*, not your guide, during this process.

The artifact file is neatly organized into sections, with HTML/CSS widgets and a concrete flow and notes contained in bullet points. This provides initial structure and guidance for the next step of drafting, but it is not a final outline. The brainstorming step is iterative and can be repeated as many times as needed until the outline feels right. The artifact from brainstorming only serves as the baseline for the writing stage, which comes later.
...
As models and harnesses continue to evolve at a rapid pace, I'm sure my workflow will keep evolving. I'm also sure I'll be modifying skills like the [brainstorming](https://github.com/prrao87/agent-skills/blob/main/skills/brainstorming/SKILL.md) one I use regularly, and adding new [writing skills](https://github.com/prrao87/agent-skills/blob/main/skills/blog-writer/SKILL.md) as I learn more about how to work with the latest generation of models. What I described here might look different six months from now, and that's fine — the core principles should still hold.
