...
<Figure src={Img1} caption="Image modified from <a href='https://travellingacrosstime.com/2015/08/23/rivers/'>this source.</a>" />
...
>
> -- Will Jones, core maintainer of `delta-rs` and `lance`, [in his blog post](https://www.datawill.io/posts/pandas-arrow-rust/)
